...
class reduceMeanLayerTest : public MultiDeviceTest<TypeParam> {
...
protected:
  ...
  virtual ~reduceMeanLayerTest() { delete blob_bottom_; delete blob_top_; }
  void TestForward(Dtype filler_std)
  {
    ...
    reduceMeanLayer<Dtype> layer(layer_param);
  ...
  TYPED_TEST_CASE(reduceMeanLayerTest, TestDtypesAndDevices);
  TYPED_TEST(reduceMeanLayerTest, TestReduceMeanLayer) {
